...
In this repository you'll find the fully reversed source code for GTA III ([master](https://github.com/animeavi/re3/tree/master/) branch) and GTA VC ([miami](https://github.com/animeavi/re3/tree/miami/) branch).
...
- re3 requires PC game assets to work, so you **must** own [a copy of GTA III](https://store.steampowered.com/app/12100/Grand_Theft_Auto_III/) (RIP).
- Build re3
...
* [PS2 port](https://github.com/animeavi/re3/wiki/PS2-port)
...
For MacOS using premake, proceed: [Building on MacOS](https://github.com/animeavi/re3/wiki/Building-on-MacOS)

</details>

<details><summary>FreeBSD</summary>

For FreeBSD using premake, proceed: [Building on FreeBSD](https://github.com/animeavi/re3/wiki/Building-on-FreeBSD)
...
**If you choose OpenAL on Windows** You must read [Running OpenAL build on Windows](https://github.com/animeavi/re3/wiki/Running-OpenAL-build-on-Windows).
</details>

> :information_source: premake has an `--with-lto` option if you want the project to be compiled with Link Time Optimization.

> :information_source: There are various settings in [config.h](https://github.com/animeavi/re3/tree/master/src/core/config.h), you may want to take a look there.
...
We have a [Coding Style](https://github.com/animeavi/re3/blob/master/CODING_STYLE.md) document that isn't followed or enforced very well.
